...
## Role & Stack
Team member responsible for database schema design, recipe CRUD operations, and search/filter functionality. Built using modern web technologies with a focus on user experience and data management.
